...
import org.styleru.hseday2017_2.AboutFacultyActivity;
...
public class RecyclerViewAdapterFaculties extends RecyclerView.Adapter<RecyclerViewAdapterFaculties.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(org.styleru.hseday2017_2.R.layout.cardview_faculty, viewGroup, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            FacultyName = (TextView)itemView.findViewById(org.styleru.hseday2017_2.R.id.faculty_name);
