...
import org.styleru.hseday2017_2.AboutOrganisationActivity;
import org.styleru.hseday2017_2.ApiClasses.ApiOrganisations;
import org.styleru.hseday2017_2.ItemClickListener;
...
public class RecyclerViewAdapterOrganisations extends RecyclerView.Adapter<RecyclerViewAdapterOrganisations.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(org.styleru.hseday2017_2.R.layout.cardview_organisation, viewGroup, false);
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener, View.OnLongClickListener{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            OrganisationName = (TextView)itemView.findViewById(org.styleru.hseday2017_2.R.id.organisation_name);
            OrganisationIcon = (ImageView) itemView.findViewById(org.styleru.hseday2017_2.R.id.organisation_icon);
