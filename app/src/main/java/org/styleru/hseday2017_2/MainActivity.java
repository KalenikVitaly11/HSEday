...
import org.styleru.hseday2017_2.NavigationFragments.FragmentAboutHSE;
import org.styleru.hseday2017_2.NavigationFragments.FragmentFaculties;
import org.styleru.hseday2017_2.NavigationFragments.FragmentMap;
import org.styleru.hseday2017_2.NavigationFragments.FragmentOrganisations;
...
public class MainActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    public static Integer questsNumber = 25;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        snackbar = Snackbar.make(getWindow().getDecorView().getRootView(), "Подарок за прохождение квеста ждет тебя в пункте выдачи", Snackbar.LENGTH_INDEFINITE);
        View sbView = snackbar.getView();
        sbView.setBackgroundColor(ContextCompat.getColor(this, R.color.actionBarbackground));
